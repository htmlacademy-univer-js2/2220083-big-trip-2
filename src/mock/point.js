...
const getOffers = () => Array.from({length: POINT_TYPES.length}).map((value, index) => generateOffersByType(POINT_TYPES[index]));
...
export {getPoints, getDestinations, getOffers, POINT_TYPES};
